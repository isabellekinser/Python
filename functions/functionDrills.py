...
#the function.
#Print what the function returns.
def addingStrings ("chocolate", " milk"):
    answer = "chocolate" + " milk"
    return "chocolate milk "
x = "chocolate"
y = " milk"
addingStrings(x,y)
print(addingStrings(x,y))
...
#call the function.
#Print what the function returns.
def boolean (num1, num2, num3,):
    answer = num1 > num2 and num3
    return False
x = 30
y = 2
z = 9
...
def colorString("pink"):
    answer = "Thats my favorite color!"
    return 
x = "pink"
colorString(x)
print(colorString(x))
